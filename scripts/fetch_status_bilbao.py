#!/usr/bin/env python3
"""
Scrapes Metro Bilbao status and updates data/bilbao_status.json.
...
MINOR_KEYWORDS = ["escalator", "lift", "elevator", "ascensor", "works",
                  "maintenance", "alteration", "out of service", "access", "improvement"]
